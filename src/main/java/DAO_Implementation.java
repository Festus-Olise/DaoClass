...
class DAO_Implementation implements DAOInterface {
    ...
    public Category edit(Category cat, String ccat) throws SQLException, ClassNotFoundException {
        ...
        query = con3.prepareStatement("Update category set catcode=?, catedesc=? where catcode = ?");
        query.setString(1, cat.getCatcode());
        query.setString(2, cat.getCatdesc());
    ...
    public void display() throws ClassNotFoundException, SQLException {
        ...
        //Display records if there's data
        while (rs.next()){
